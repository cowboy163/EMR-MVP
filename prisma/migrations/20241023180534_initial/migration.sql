...
-- CreateIndex
CREATE UNIQUE INDEX "Doctor_memberId_key" ON "Doctor"("memberId");
...
-- AddForeignKey
ALTER TABLE "Doctor" ADD CONSTRAINT "Doctor_memberId_fkey" FOREIGN KEY ("memberId") REFERENCES "Member"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Patient" ADD CONSTRAINT "Patient_memberId_fkey" FOREIGN KEY ("memberId") REFERENCES "Member"("id") ON DELETE CASCADE ON UPDATE CASCADE;
