...
export default async function AdminPortalMessagesPage({ searchParams }: { searchParams: { container: string } }) {
    ...
    return (
        ...
        >
            ...
            >
                <MessageTable initialMessages={messages} rolePlatform='ADMIN' nextCursor={nextCursor} />
            </div>
        </div>
    )
}
