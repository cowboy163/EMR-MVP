...
export default async function PatientMessagesPage({ searchParams }: { searchParams: { container: string } }) {
  ...
  return (
    ...
    >
      ...
      >
        <MessageTable initialMessages={messages} rolePlatform='PATIENT' nextCursor={nextCursor} />
      </div>
    </div>
  )
}
