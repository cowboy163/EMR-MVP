...
import { adminProfileSchema, AdminRegisterSchema, memberProfileSchema, registerSchema } from '@/lib/schemas/registerSchema'
...
export default function AdminRegisterForm() {
    ...
    const methods = useForm<AdminRegisterSchema>({
    ...
    const onSubmit = async () => {
        const result = await registerUser(getValues(), 'ADMIN')
